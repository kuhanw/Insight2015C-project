...
hist_1.Draw('COLZ')
c_hist_1.SaveAs('k_fold_valid_p_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_2.Draw('COLZ')
c_hist_2.SaveAs('k_fold_valid_pvsr_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_3.Draw('COLZ')
c_hist_3.SaveAs('k_fold_valid_pvsa_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_4.Draw('COLZ')
c_hist_4.SaveAs('k_fold_valid_pvsl_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_5.Draw('COLZ')
c_hist_5.SaveAs('k_fold_valid_rvsa_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_6.Draw('COLZ')
c_hist_6.SaveAs('k_fold_valid_rvsl_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_7.Draw('COLZ')
c_hist_7.SaveAs('k_fold_valid_avsl_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_8.Draw('COLZ')
c_hist_8.SaveAs('k_fold_valid_f1vsa_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_9.Draw('COLZ')
c_hist_9.SaveAs('k_fold_valid_f1vsl_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
...
hist_10.Draw('COLZ')
c_hist_10.SaveAs('k_fold_valid_f1vsr_result_' + widget  + '_validation_1_2_' + str(Min_DF) + '_' + str(PagesLoaded) + '_' + str(algo) + '_1'+ '.pdf')
