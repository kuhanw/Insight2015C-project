...
def post_processing(model_results, model_scores, training_set, target, widget, list_of_features, 
	...
	for i in range(len(list_of_features)):
		word_priority_list = [list_of_features[i], i, 
							forest_results_parameters[2][i], SGD_results_parameters[2][0][i], logistic_results_parameters[2][0][i] ] 
		word_priority.append(word_priority_list)


	#######RANK WORDS BY COEFFICIENTS###########
